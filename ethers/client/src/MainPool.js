        ...
        <div>
            ...
            <div>
                <div>
                    ...
                    <input type="text" placeholder="Amount A" value={token1Value} onChange={Token1ValueHandeler} />
                    <input type="number" placeholder="Amount B" value={token2Value} onChange={Token2ValueHandeler} /> 
                    {/* <input type="text" placeholder="AmountB" value={token2Value} onChange={Token2ValueHandeler} /> */}

                    <button onClick={AddLiquidity}>Add Liqudity</button>
                </div>
            </div>
